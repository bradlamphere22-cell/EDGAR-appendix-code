...
- `data/edgar_concise_sanitized.json`  
...
If you relocate the JSON, update the `IN_JSON = ...` assignment near the top of the relevant notebook section(s).



### Provenance / “original notebook”

The file `notebooks/A Random Walk Down EDGAR Street.ipynb` is the original reproduction notebook referenced by the redistribution conditions in LICENSE.
